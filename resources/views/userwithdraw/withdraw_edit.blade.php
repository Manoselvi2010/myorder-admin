...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('admin/withdraw/USD') }}"><i class="zmdi zmdi-arrow-left"></i> Back to withdraw history</a>
					<br /><br />
				     <form method="post" id="currency_form" action="{{ url('admin/withdraw_update') }}" autocomplete="off" onsubmit="btn_update.disabled = true; return true;">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Requested Withdraw Amount (USD)</label>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Total Deducted Amount (USD)</label>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
					...
					<form>
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" class="form-control" value="{{ bank($withdraw->bank_name)->bank_name }}" readonly /><i class="form-group__bar"></i>
								</div>
							</div>
						</div> 
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" class="form-control" value="{{ bank($withdraw->bank_name)->account_number }}" readonly /><i class="form-group__bar"></i>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" class="form-control" value="{{ bank($withdraw->bank_name)->account_name }}" readonly /><i class="form-group__bar"></i>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" class="form-control" value="{{ bank($withdraw->bank_name)->swift_code }}" readonly /><i class="form-group__bar"></i>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" class="form-control" value="{{ bank($withdraw->bank_name)->bank_address }}" readonly /><i class="form-group__bar"></i>
								</div>
							</div>
						</div>
					</form>
