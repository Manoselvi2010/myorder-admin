...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('admin/executive_team') }}"><i class="zmdi zmdi-arrow-left"></i> Back to Executive Team</a>
					<br /><br />
					<form method="post" action="{{ url('admin/project_advisor_update') }}" enctype="multipart/form-data" autocomplete="off">
						{{ csrf_field() }}
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" name="name" class="form-control" value="{{ $commission->name}}"><i class="form-group__bar"></i>
						...
						<div class="row">
							...
							<div class="col-md-7">
								<div class="form-group">
									 <textarea class="ckeditor" name="position">
						        @if(isset($commission) > 0)
                                    @php $data = str_replace(array("\r\n", "\r", "\n"), " ", $commission->position) @endphp
                                    {{ $data }}
                                @endif
						   </textarea>
