            ...
            <div class="col-md-12 col-sm-12 col-xs-12 site-size">
              <div class="banner-border">
                <div class="pull-right">
                  ...
                  <select class="btn btn-gray site-btn mt-20 m-btn text-uppercase nova-font-bold" id="pairsell" name="pair" style="margin-top: 0px;">
                ...
                <div class="panel panel-content panel-default panel-border">
                  <div class="panel-body pt-0">
                    <div class="testDiv4">
                      <div class="table-responsive table" id="trade_history"></div>
                    </div>                   
                  </div>
                </div>
              </div>
...
<script>
  ...
  $('#pairsell').on('change', function(event){
    selltrade_search()
  });
  function selltrade_search(){   
    $.ajax({
      url: '{{ url("/admin/selltrade_his_search") }}',
      type: 'POST',
      data: {
        "_token": "{{ csrf_token() }}",
        "pair": $('#pairsell').val(),
