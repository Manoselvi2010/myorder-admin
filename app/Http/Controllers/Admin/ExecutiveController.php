...
class ExecutiveController extends Controller
{
    ...
    {
         $faq = Executive::on('mysql2')->paginate(15);
        return view('settings.executive_team.team')->with('faq',$faq);
    }
    ...
    {
         $faq = Executive::find($id);

        return view('settings.executive_team.editteam')->with('commission',$faq);
    }
    ...
    {
         $commission = Executive::on('mysql2')->where('id', $request->id)->first();
        ...
        return redirect('admin/executive_team')->with('status','Updated Successfully');
    }
