...
class PartnersController extends Controller
{
    ...
    {
         $faq = Partners::on('mysql2')->paginate(15);

        return view('settings.partners.blog')->with('faq',$faq);
    }
    ...
    {
         $faq = Partners::find($id);

        return view('settings.partners.editblog')->with('commission',$faq);
    }
    ...
    {
         $commission = Partners::on('mysql2')->where('id', $request->id)->first();
        ...
        return redirect('admin/partners')->with('status','Updated Successfully');
    }
